...
- Owns FMG tenant frontend UI, routing, branding, and tenant-specific client behavior.
...
- Add `CONTEXT.md` for FMG-specific domain terms when the project needs local vocabulary.
