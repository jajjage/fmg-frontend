  ...
  <View style={styles.stepsList}>
    ...
    <View style={styles.step}>
      ...
      <View style={styles.stepContent}>
        ...
        <Text style={styles.stepDescription}>Apply to future purchases</Text>
      </View>
    </View>
  </View>
</View>
...
export function RewardsScreen() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* Main Cashback Card */}
      <LinearGradient colors={["#e69e19", "#d4891a"]} style={styles.mainCard}>
        ...
        {[
          {
            ...
            desc: "Buy airtime, data, or pay bills",
          },
          {
            step: 2,
            title: "Earn Cashback",
            desc: "Get percentage back as cashback",
          },
